...
let BarberControllerImpl = {
    ...
    addPrintingRoom: {controller: 'BarberControllerImpl' , method: 'addPrintingRoom'}, // 发布文印室
    addPrintingRoomUser: {controller: 'BarberControllerImpl' , method: 'addPrintingRoomUser'}, // 预约文印室
    ...
    deletePrintingRoom: {controller: 'BarberControllerImpl' , method: 'deletePrintingRoom'}, // 删除一个发布的文印室信息
    ...
    queryByMonthForGather: {controller: 'BarberControllerImpl' , method: 'queryByMonthForGather'}, // 根据日期进行查询预约情况
    ...
    queryByStateForGather: {controller: 'BarberControllerImpl' , method: 'queryByStateForGather'}, // 根据预约状态查询所有的预约情况
    queryByStateForPrintingRoom: {controller: 'BarberControllerImpl' , method: 'queryByStateForPrintingRoom'}, // 根据预约状态查询文印室的预约情况
    ...
    queryByTypeAndDateForPrintingRoom: {controller: 'BarberControllerImpl' , method: 'queryByTypeAndDateForPrintingRoom'}, // 根据预约类型和日期查询文印室的预约情况  名额
    ...
    updateCancelForPrintingRoom: {controller: 'BarberControllerImpl' , method: 'updateCancelForPrintingRoom'}, // 取消文印室预约
    ...
    updatePrintingRoom: {controller: 'BarberControllerImpl' , method: 'updatePrintingRoom'}, // 修改发布的文印室信息
    ...
    updateSignForPrintingRoom: {controller: 'BarberControllerImpl' , method: 'updateSignForPrintingRoom'}, // 文印室预约签到
    ...
    updateZeroRestaurant: {controller: 'BarberControllerImpl' , method: 'updateZeroRestaurant'}, // 修改��布的零点餐厅信息
};
 //fileupload
let fileupload = {
    __name: 'fileupload',
