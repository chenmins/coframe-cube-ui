          ...
          >
            <cube-form-group>
              <cube-form-item :field="form[0]">
                <div class="time-show" @click="showTimePicker">
                  {{ model.time || form[0].props.placeholder }}
                  <i class="cubeic-arrow" style="float: right; margin-right: 16px"></i>
                </div>
              </cube-form-item>
              <cube-form-item :field="form[1]">
                <div @click="showPicker('来访人数', maxPeople)">
                  {{ model.peopleNum || form[1].props.placeholder }}
            ...
            <cube-form-group>
              <cube-form-item :field="form[2]"> </cube-form-item>
              <cube-form-item :field="form[3]">
                <div @click="showPicker('来访区域', column1)">
                  {{ model.to || form[3].label }}
                  <i class="cubeic-arrow" style="float: right; margin-right: 16px"></i>
                </div>
              </cube-form-item>
              <cube-form-item :field="form[4]"> </cube-form-item>
            </cube-form-group>
...
export default {
  ...
  methods: {
    ...
    submitGuestForm(e, model, model2) {
      ...
      this.$axios.post('/platform/visitor/saveAppointmentInfo',{
